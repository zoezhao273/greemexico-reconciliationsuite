...
**Check 4 — Gas material.** Runs when the invoice is gasoline — CFDI `Conceptos ClaveProdServ SAT` contains one of the SAT product/service codes `15101506`, `15101514`, or `15101515`. The required `Material` depends on the payment form, and the **NCC (recorded)** column is left blank in both cases:
